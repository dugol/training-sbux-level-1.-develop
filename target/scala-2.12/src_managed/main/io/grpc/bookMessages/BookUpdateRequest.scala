...
@SerialVersionUID(0L)
final case class BookUpdateRequest(
    isbn: String = "",
    tittle: String = "",
    author: String = "",
    gender: String = "",
    ...
    country: String = "",
    edition: Int = 0
    ) extends com.trueaccord.scalapb.GeneratedMessage with com.trueaccord.scalapb.Message[BookUpdateRequest] with com.trueaccord.lenses.Updatable[BookUpdateRequest] {
    @transient
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.grpc.bookMessages.BookUpdateRequest = {
    ...
    def withIsbn(__v: String): BookUpdateRequest = copy(isbn = __v)
    def withTittle(__v: String): BookUpdateRequest = copy(tittle = __v)
    def withAuthor(__v: String): BookUpdateRequest = copy(author = __v)
    def withGender(__v: String): BookUpdateRequest = copy(gender = __v)
    def withPublisher(__v: String): BookUpdateRequest = copy(publisher = __v)
    def withCountry(__v: String): BookUpdateRequest = copy(country = __v)
    def withEdition(__v: Int): BookUpdateRequest = copy(edition = __v)
    ...
    def companion = io.grpc.bookMessages.BookUpdateRequest
}

object BookUpdateRequest extends com.trueaccord.scalapb.GeneratedMessageCompanion[io.grpc.bookMessages.BookUpdateRequest] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[io.grpc.bookMessages.BookUpdateRequest] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): io.grpc.bookMessages.BookUpdateRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.grpc.bookMessages.BookUpdateRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = BookMessagesProto.javaDescriptor.getMessageTypes.get(6)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = BookMessagesProto.scalaDescriptor.messages(6)
  ...
  lazy val defaultInstance = io.grpc.bookMessages.BookUpdateRequest(
  )
  implicit class BookUpdateRequestLens[UpperPB](_l: _root_.com.trueaccord.lenses.Lens[UpperPB, io.grpc.bookMessages.BookUpdateRequest]) extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB, io.grpc.bookMessages.BookUpdateRequest](_l) {
