...
@SerialVersionUID(0L)
final case class BookCreateRequest(
    isbn: String = "",
    tittle: String = "",
    author: String = "",
    gender: String = "",
    ...
    country: String = "",
    edition: Int = 0
    ) extends com.trueaccord.scalapb.GeneratedMessage with com.trueaccord.scalapb.Message[BookCreateRequest] with com.trueaccord.lenses.Updatable[BookCreateRequest] {
    @transient
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.grpc.bookMessages.BookCreateRequest = {
    ...
    def withIsbn(__v: String): BookCreateRequest = copy(isbn = __v)
    def withTittle(__v: String): BookCreateRequest = copy(tittle = __v)
    def withAuthor(__v: String): BookCreateRequest = copy(author = __v)
    def withGender(__v: String): BookCreateRequest = copy(gender = __v)
    def withPublisher(__v: String): BookCreateRequest = copy(publisher = __v)
    def withCountry(__v: String): BookCreateRequest = copy(country = __v)
    def withEdition(__v: Int): BookCreateRequest = copy(edition = __v)
    ...
    def companion = io.grpc.bookMessages.BookCreateRequest
}

object BookCreateRequest extends com.trueaccord.scalapb.GeneratedMessageCompanion[io.grpc.bookMessages.BookCreateRequest] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[io.grpc.bookMessages.BookCreateRequest] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): io.grpc.bookMessages.BookCreateRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.grpc.bookMessages.BookCreateRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = BookMessagesProto.javaDescriptor.getMessageTypes.get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = BookMessagesProto.scalaDescriptor.messages(0)
  ...
  lazy val defaultInstance = io.grpc.bookMessages.BookCreateRequest(
  )
  implicit class BookCreateRequestLens[UpperPB](_l: _root_.com.trueaccord.lenses.Lens[UpperPB, io.grpc.bookMessages.BookCreateRequest]) extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB, io.grpc.bookMessages.BookCreateRequest](_l) {
